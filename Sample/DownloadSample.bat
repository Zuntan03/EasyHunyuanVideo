...
echo.
echo %CURL_CMD% --no-cache -O "https://yyy.wpx.jp/EasyHunyuanVideo/Sample/SampleList.txt"
%CURL_CMD% --no-cache -O "https://yyy.wpx.jp/EasyHunyuanVideo/Sample/SampleList.txt"
