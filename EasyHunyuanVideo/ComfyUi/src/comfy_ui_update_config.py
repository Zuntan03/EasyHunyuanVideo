...
class ComfyUiConfig:
    ...
    def __init__(self, cfg_path):
        ...
        with open(cfg_path, "r+", encoding="utf-8") as f:
            cfg = json.load(f)
            if "easy_hunyuan_video_config_version" not in cfg:
                cfg["easy_hunyuan_video_config_version"] = "0.0.0"
    ...
    def update(self, cfg):
        version = cfg["easy_hunyuan_video_config_version"]
    ...
    def update_0_0_0(self, cfg):
        cfg["easy_hunyuan_video_config_version"] = "0.1.0"
